  ...
  <div>
    ...
    >
      ...
      <div id="nav-link-container">
        <scroll-link class="nav-link" to="0">首页</scroll-link>
        <scroll-link class="nav-link" to="graph-1">关于</scroll-link>
        <scroll-link class="nav-link" to="graph-2">XX</scroll-link>
        <scroll-link class="nav-link" to="graph-3">XX</scroll-link>
